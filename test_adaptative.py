...
skymap= "/home/weizmann.kiendrebeogo/M4OPT-ULTRSASAT/runs_SNR-10/O5HLVK/farah/allsky/0.fits"
...
distmean, diststd, _ = distance.parameters_to_moments( skymap_flat["DISTMU"], skymap_flat["DISTSIGMA"])
...
appmag_quantiles = stats.norm(loc=appmag_mu[:, np.newaxis], scale=appmag_sigma[:, np.newaxis]).ppf(quantiles)
appmag_quantiles[0]